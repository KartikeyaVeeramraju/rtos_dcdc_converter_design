...
R_min = Vout^2/Power_rating_max;
R_max = Vout^2/Power_rating_min;
...
L_design = 0.7*3.3e-6; % oversizing over the critical inductance
...
C_selected = 5.6e-6; %derated value after accounting dc bias and frequency effects
ESR_Sel = (1/(2*pi*f*C_selected))*DF;
ESR_Sel = 0.005;
...
Target_Voltage_max = I_max*R_sense_max;
...
V_sense_min = Vos/(error_allowable/100);%R_sense_min*I_limit;%;
R_sense_min = V_sense_min/I_max;
